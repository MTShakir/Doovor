-- Making a booking (BOK-01, BOK-02, R-10, M2-14).
--
-- Every booking in the product goes through this one function: the diary sheet, the public
-- booking page, and anything later. It works out who is asking, what they are allowed to
-- book, what it costs, and whether the slot is free, then writes the row, the audit line and
-- the message to send, all in one transaction (R-10).
...
begin
  ...
  -- A request nobody answered stops holding the slot the moment it lapses (R-12).
