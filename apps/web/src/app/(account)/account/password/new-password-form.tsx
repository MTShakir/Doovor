...
import { newPasswordSchema, passwordMinLength } from '@repo/core/schemas/auth';
...
export function NewPasswordForm() {
  ...
  return (
    <ClientForm onSubmit={onSubmit} pending={pending} className="flex flex-col gap-4">
      ...
      <Field label="New password" hint={`At least ${String(passwordMinLength)} characters.`} error={form.formState.errors.password?.message}>
