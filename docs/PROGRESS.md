...
| Database (pgTAP) | 258 assertions in 19 files, all passing; SQL lint clean |
...
- M1-16: pickup points, stored per learner.

## Next

- M1-16, then the diary: working hours and exceptions, booking rules, and the day, week and month views.
